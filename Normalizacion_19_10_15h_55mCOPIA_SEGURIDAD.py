...
def eliminacionColumnas(archivo, columnas_a_eliminar):
    ...
    nuevoArchivo = pd.read_csv(archivo, low_memory=False)
    # Eliminar las columnas especificadas
    nuevoArchivo = nuevoArchivo.drop(columns=columnas_a_eliminar, errors="ignore")
    return nuevoArchivo
...
def normalizarCatalogoDeMedicamentos():
...
def dividirCategorias():
    #llamar a la primera funcion 
    nuevoArchivo2 = normalizarCatalogoDeMedicamentos()
...
def main():
    ...
    nuevoArchivo1 = normalizarArchivo1()
    ...
    nuevoArchivo2 = normalizarArchivo2()
    ...
    nuevoArchivo3 = normalizarArchivo3()
    ...
    nuevoArchivo4 = normalizarArchivo4()
    ...
    nuevoArchivo5 = normalizarArchivo5()
